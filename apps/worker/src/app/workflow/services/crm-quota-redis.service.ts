...
/**
 * izipush-crm — connexion Redis des quotas des fournisseurs email, sur le Redis des files (REDIS_HOST).
 * Indépendante du cache Novu, souvent désactivé en auto-hébergé : l'activer changerait le comportement de tout Novu.
 */
@Injectable()
