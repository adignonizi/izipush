import { ResourceOriginEnum, Slug, StepTypeEnum, ToolProviderIdEnum } from '../../types';
...
export enum UiComponentEnum {
  ...
  /** izipush-crm — choix d'un template email CRM dans une étape email */
  CRM_TEMPLATE_SELECT = 'CRM_TEMPLATE_SELECT',
